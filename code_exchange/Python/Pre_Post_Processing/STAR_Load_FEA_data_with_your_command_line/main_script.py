...
if __name__ == "__main__":
    lens_file = Path(r"Path\of\your\zmxFile")
    folder = Path(r"Path\of\your\fea\folder")
    fea_file = folder.joinpath("FEAData.txt")
    surface_id = 3
    reference_coordinate = "global"
    transform_decenter = [0, 0, 0]
    transform_rotation = [0, 0, 0]

    zos = ZOSConnector()
    zos.OpenFile(str(lens_file), False)
